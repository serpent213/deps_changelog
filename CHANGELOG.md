...
- Fallback for version with status `:compile` dependencies by Ross van Zyl (@rossvz)
- Version handling for dependencies with git hash versions

### Changed

- Dropped application from mix.exs configuration
